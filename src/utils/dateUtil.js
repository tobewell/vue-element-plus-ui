 ...
 * @returns {string}
 */
exports.getMonth = function(date,type){
    if(date){
        ...
        var dateStr = '';
        switch (type) {
            case MONTHTYPE.ZH_MONTHNAME:
                dateStr = _options.ZH.monthNames[index];
                break;
            case MONTHTYPE.ZH_SMONTHNAME:
                dateStr = _options.ZH.shortMonthNames[index];
                break;
            case MONTHTYPE.US_MONTHNAME:
                dateStr = _options.US.monthNames[index];
                break;
            case MONTHTYPE.US_SMONTHNAME:
                dateStr = _options.US.shortMonthNames[index];
                break;
        }
        return dateStr;
    }
